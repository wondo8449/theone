...
class _AcceptedPageState extends ConsumerState<AcceptedPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('개인정보 이용 동의', style: AppTypography.headline3.copyWith(color: AppColors.grayScale_950)), centerTitle: true),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Text(
              '1. 교회에서 요청하는 개인정보 항목', style: AppTypography.headline6
            ),
            SizedBox(height: 4),
            Text(
              '- 이름'
            ...
            SizedBox(height: 20),
            Text(
              '2. 이용 목적', style: AppTypography.headline6
            ),
            SizedBox(height: 4),
            Text(
            ...
            SizedBox(height: 20),
            Text(
              '3. 개인정보의 보유 및 이용 기간', style: AppTypography.headline6
            ),
            SizedBox(height: 4),
            Text(
              '개인정보보호법 58조 4항에 의거 "종교단체가 선교등 고유 목적을 달성하기 위하여'
